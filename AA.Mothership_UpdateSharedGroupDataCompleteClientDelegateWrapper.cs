...
public class UpdateSharedGroupDataCompleteClientDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateUpdateSharedGroupDataCompleteClientDelegateWrapper_0 swigDelegate0;
	...
	internal UpdateSharedGroupDataCompleteClientDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.UpdateSharedGroupDataCompleteClientDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_UpdateSharedGroupDataCompleteClientDelegateWrapper(swigCPtr);
				}
	...
	public UpdateSharedGroupDataCompleteClientDelegateWrapper()
		: this(MothershipApiPINVOKE.new_UpdateSharedGroupDataCompleteClientDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.UpdateSharedGroupDataCompleteClientDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateUpdateSharedGroupDataCompleteClientDelegateWrapper_0))]
