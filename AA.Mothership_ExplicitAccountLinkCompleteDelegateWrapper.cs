...
public class ExplicitAccountLinkCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateExplicitAccountLinkCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal ExplicitAccountLinkCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.ExplicitAccountLinkCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_ExplicitAccountLinkCompleteDelegateWrapper(swigCPtr);
				}
	...
	public ExplicitAccountLinkCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_ExplicitAccountLinkCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.ExplicitAccountLinkCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateExplicitAccountLinkCompleteDelegateWrapper_0))]
