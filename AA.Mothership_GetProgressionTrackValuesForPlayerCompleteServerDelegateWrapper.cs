...
public class GetProgressionTrackValuesForPlayerCompleteServerDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateGetProgressionTrackValuesForPlayerCompleteServerDelegateWrapper_0 swigDelegate0;
	...
	internal GetProgressionTrackValuesForPlayerCompleteServerDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.GetProgressionTrackValuesForPlayerCompleteServerDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_GetProgressionTrackValuesForPlayerCompleteServerDelegateWrapper(swigCPtr);
				}
	...
	public GetProgressionTrackValuesForPlayerCompleteServerDelegateWrapper()
		: this(MothershipApiPINVOKE.new_GetProgressionTrackValuesForPlayerCompleteServerDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.GetProgressionTrackValuesForPlayerCompleteServerDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateGetProgressionTrackValuesForPlayerCompleteServerDelegateWrapper_0))]
