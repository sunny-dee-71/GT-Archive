...
public class UpdateSharedGroupDataCompleteServerDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateUpdateSharedGroupDataCompleteServerDelegateWrapper_0 swigDelegate0;
	...
	internal UpdateSharedGroupDataCompleteServerDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.UpdateSharedGroupDataCompleteServerDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_UpdateSharedGroupDataCompleteServerDelegateWrapper(swigCPtr);
				}
	...
	public UpdateSharedGroupDataCompleteServerDelegateWrapper()
		: this(MothershipApiPINVOKE.new_UpdateSharedGroupDataCompleteServerDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.UpdateSharedGroupDataCompleteServerDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateUpdateSharedGroupDataCompleteServerDelegateWrapper_0))]
