...
public class UpdateInsecure2ConfigCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateUpdateInsecure2ConfigCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal UpdateInsecure2ConfigCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.UpdateInsecure2ConfigCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_UpdateInsecure2ConfigCompleteDelegateWrapper(swigCPtr);
				}
	...
	public UpdateInsecure2ConfigCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_UpdateInsecure2ConfigCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.UpdateInsecure2ConfigCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateUpdateInsecure2ConfigCompleteDelegateWrapper_0))]
