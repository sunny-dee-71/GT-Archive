...
public class CreateProgressionTreeBindingsCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateCreateProgressionTreeBindingsCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal CreateProgressionTreeBindingsCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.CreateProgressionTreeBindingsCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_CreateProgressionTreeBindingsCompleteDelegateWrapper(swigCPtr);
				}
	...
	public CreateProgressionTreeBindingsCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_CreateProgressionTreeBindingsCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.CreateProgressionTreeBindingsCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateCreateProgressionTreeBindingsCompleteDelegateWrapper_0))]
