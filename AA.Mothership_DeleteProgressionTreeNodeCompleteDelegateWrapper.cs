...
public class DeleteProgressionTreeNodeCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateDeleteProgressionTreeNodeCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal DeleteProgressionTreeNodeCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.DeleteProgressionTreeNodeCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_DeleteProgressionTreeNodeCompleteDelegateWrapper(swigCPtr);
				}
	...
	public DeleteProgressionTreeNodeCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_DeleteProgressionTreeNodeCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.DeleteProgressionTreeNodeCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateDeleteProgressionTreeNodeCompleteDelegateWrapper_0))]
