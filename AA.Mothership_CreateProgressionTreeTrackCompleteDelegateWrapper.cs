...
public class CreateProgressionTreeTrackCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateCreateProgressionTreeTrackCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal CreateProgressionTreeTrackCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.CreateProgressionTreeTrackCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_CreateProgressionTreeTrackCompleteDelegateWrapper(swigCPtr);
				}
	...
	public CreateProgressionTreeTrackCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_CreateProgressionTreeTrackCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.CreateProgressionTreeTrackCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateCreateProgressionTreeTrackCompleteDelegateWrapper_0))]
