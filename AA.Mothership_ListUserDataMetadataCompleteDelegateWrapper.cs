...
public class ListUserDataMetadataCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateListUserDataMetadataCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal ListUserDataMetadataCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.ListUserDataMetadataCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_ListUserDataMetadataCompleteDelegateWrapper(swigCPtr);
				}
	...
	public ListUserDataMetadataCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_ListUserDataMetadataCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.ListUserDataMetadataCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateListUserDataMetadataCompleteDelegateWrapper_0))]
