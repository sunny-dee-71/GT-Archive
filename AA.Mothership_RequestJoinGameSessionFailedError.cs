...
public class RequestJoinGameSessionFailedError : MothershipError
{
	...
	internal RequestJoinGameSessionFailedError(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.RequestJoinGameSessionFailedError_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	public RequestJoinGameSessionFailedError(string message, int statusCode, string traceId, string mothershipErrorCode)
		: this(MothershipApiPINVOKE.new_RequestJoinGameSessionFailedError__SWIG_0(message, statusCode, traceId, mothershipErrorCode), cMemoryOwn: true)
	{
	...
	public RequestJoinGameSessionFailedError(string message, int statusCode, string traceId)
		: this(MothershipApiPINVOKE.new_RequestJoinGameSessionFailedError__SWIG_1(message, statusCode, traceId), cMemoryOwn: true)
	{
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
	...
	public RequestJoinGameSessionFailedError(string message, int statusCode)
		: this(MothershipApiPINVOKE.new_RequestJoinGameSessionFailedError__SWIG_2(message, statusCode), cMemoryOwn: true)
	{
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
