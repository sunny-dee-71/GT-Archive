...
public class GetUserDataCompleteAutomationDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateGetUserDataCompleteAutomationDelegateWrapper_0 swigDelegate0;
	...
	internal GetUserDataCompleteAutomationDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.GetUserDataCompleteAutomationDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_GetUserDataCompleteAutomationDelegateWrapper(swigCPtr);
				}
	...
	public GetUserDataCompleteAutomationDelegateWrapper(MothershipAutomationApiClient automationApiClient)
		: this(MothershipApiPINVOKE.new_GetUserDataCompleteAutomationDelegateWrapper__SWIG_0(MothershipAutomationApiClient.getCPtr(automationApiClient)), cMemoryOwn: true)
	{
	...
	public GetUserDataCompleteAutomationDelegateWrapper(GetUserDataCompleteAutomationDelegateWrapper other)
		: this(MothershipApiPINVOKE.new_GetUserDataCompleteAutomationDelegateWrapper__SWIG_1(getCPtr(other)), cMemoryOwn: true)
	{
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.GetUserDataCompleteAutomationDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateGetUserDataCompleteAutomationDelegateWrapper_0))]
