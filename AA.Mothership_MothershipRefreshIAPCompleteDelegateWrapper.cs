...
public class MothershipRefreshIAPCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateMothershipRefreshIAPCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal MothershipRefreshIAPCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.MothershipRefreshIAPCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_MothershipRefreshIAPCompleteDelegateWrapper(swigCPtr);
				}
	...
	public MothershipRefreshIAPCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_MothershipRefreshIAPCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.MothershipRefreshIAPCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateMothershipRefreshIAPCompleteDelegateWrapper_0))]
