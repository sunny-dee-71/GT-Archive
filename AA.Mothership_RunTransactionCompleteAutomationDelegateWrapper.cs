...
public class RunTransactionCompleteAutomationDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateRunTransactionCompleteAutomationDelegateWrapper_0 swigDelegate0;
	...
	internal RunTransactionCompleteAutomationDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.RunTransactionCompleteAutomationDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_RunTransactionCompleteAutomationDelegateWrapper(swigCPtr);
				}
	...
	public RunTransactionCompleteAutomationDelegateWrapper()
		: this(MothershipApiPINVOKE.new_RunTransactionCompleteAutomationDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.RunTransactionCompleteAutomationDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateRunTransactionCompleteAutomationDelegateWrapper_0))]
