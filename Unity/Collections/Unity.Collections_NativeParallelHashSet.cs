...
public struct NativeParallelHashSet<T>(int capacity, AllocatorManager.AllocatorHandle allocator) : INativeDisposable, IDisposable, IEnumerable<T>, IEnumerable where T : unmanaged, IEquatable<T>
{
	...
	internal NativeParallelHashMap<T, bool> m_Data = new NativeParallelHashMap<T, bool>(capacity, allocator);
