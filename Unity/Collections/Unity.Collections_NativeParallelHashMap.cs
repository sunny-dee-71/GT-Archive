...
public struct NativeParallelHashMap<TKey, TValue>(int capacity, AllocatorManager.AllocatorHandle allocator) : INativeDisposable, IDisposable, IEnumerable<KeyValue<TKey, TValue>>, IEnumerable where TKey : unmanaged, IEquatable<TKey> where TValue : unmanaged
{
	[NativeContainer]
	...
	internal UnsafeParallelHashMap<TKey, TValue> m_HashMapData = new UnsafeParallelHashMap<TKey, TValue>(capacity, allocator);
