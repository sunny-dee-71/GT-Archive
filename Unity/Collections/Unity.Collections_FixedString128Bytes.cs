...
{
	public struct Enumerator(FixedString128Bytes other) : IEnumerator
	{
		private FixedString128Bytes target = other;

		private int offset = 0;

		private Unicode.Rune current = default(Unicode.Rune);
