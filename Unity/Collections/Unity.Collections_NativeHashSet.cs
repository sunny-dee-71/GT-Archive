...
public unsafe struct NativeHashSet<T>(int initialCapacity, AllocatorManager.AllocatorHandle allocator) : INativeDisposable, IDisposable, IEnumerable<T>, IEnumerable where T : unmanaged, IEquatable<T>
{
	[NativeContainer]
	...
	[NativeDisableUnsafePtrRestriction]
	internal unsafe HashMapHelper<T>* m_Data = HashMapHelper<T>.Alloc(initialCapacity, 0, 256, allocator);
