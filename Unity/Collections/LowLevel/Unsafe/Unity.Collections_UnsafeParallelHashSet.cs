...
public struct UnsafeParallelHashSet<T>(int capacity, AllocatorManager.AllocatorHandle allocator) : INativeDisposable, IDisposable, IEnumerable<T>, IEnumerable where T : unmanaged, IEquatable<T>
{
	...
	internal UnsafeParallelHashMap<T, bool> m_Data = new UnsafeParallelHashMap<T, bool>(capacity, allocator);
