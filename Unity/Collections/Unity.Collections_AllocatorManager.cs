	...
	internal struct StackAllocator : IAllocator, IDisposable
	{
		...
		internal static class Try_000000AB$BurstDirectCall
		{
			...
			private static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = BurstCompiler.CompileFunctionPointer<Try_000000AB$PostfixBurstDelegate>(Try).Value;
				}
				P_0 = Pointer;
			}
	...
	internal struct SlabAllocator : IAllocator, IDisposable
	{
		...
		internal static class Try_000000B9$BurstDirectCall
		{
			...
			private static void GetFunctionPointerDiscard(ref IntPtr P_0)
			{
				if (Pointer == (IntPtr)0)
				{
					Pointer = BurstCompiler.CompileFunctionPointer<Try_000000B9$PostfixBurstDelegate>(Try).Value;
				}
				P_0 = Pointer;
			}
