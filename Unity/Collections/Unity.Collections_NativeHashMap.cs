...
public unsafe struct NativeHashMap<TKey, TValue>(int initialCapacity, AllocatorManager.AllocatorHandle allocator) : INativeDisposable, IDisposable, IEnumerable<KVPair<TKey, TValue>>, IEnumerable where TKey : unmanaged, IEquatable<TKey> where TValue : unmanaged
{
	[NativeContainer]
	...
	[NativeDisableUnsafePtrRestriction]
	internal unsafe HashMapHelper<TKey>* m_Data = HashMapHelper<TKey>.Alloc(initialCapacity, sizeof(TValue), 256, allocator);
