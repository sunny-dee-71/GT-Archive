...
public static class xxHash3
{
	...
	internal static class Hash64Long_00000A6B$BurstDirectCall
	{
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<Hash64Long_00000A6B$PostfixBurstDelegate>(Hash64Long).Value;
			}
			P_0 = Pointer;
		}
	...
	internal static class Hash128Long_00000A72$BurstDirectCall
	{
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<Hash128Long_00000A72$PostfixBurstDelegate>(Hash128Long).Value;
			}
			P_0 = Pointer;
		}
	...
	[BurstCompile]
	[MonoPInvokeCallback(typeof(Hash64Long_00000A6B$PostfixBurstDelegate))]
	private unsafe static ulong Hash64Long(byte* input, byte* dest, long length, byte* secret)
	{
		return Hash64Long_00000A6B$BurstDirectCall.Invoke(input, dest, length, secret);
	}
	...
	[BurstCompile]
	[MonoPInvokeCallback(typeof(Hash128Long_00000A72$PostfixBurstDelegate))]
	private unsafe static void Hash128Long(byte* input, byte* dest, long length, byte* secret, out uint4 result)
	{
		Hash128Long_00000A72$BurstDirectCall.Invoke(input, dest, length, secret, out result);
	}
