...
public class CreateMuteCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateCreateMuteCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal CreateMuteCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.CreateMuteCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_CreateMuteCompleteDelegateWrapper(swigCPtr);
				}
	...
	public CreateMuteCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_CreateMuteCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.CreateMuteCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateCreateMuteCompleteDelegateWrapper_0))]
