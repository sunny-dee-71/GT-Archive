...
public class UpdateProgressionTreeCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateUpdateProgressionTreeCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal UpdateProgressionTreeCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.UpdateProgressionTreeCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_UpdateProgressionTreeCompleteDelegateWrapper(swigCPtr);
				}
	...
	public UpdateProgressionTreeCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_UpdateProgressionTreeCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.UpdateProgressionTreeCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateUpdateProgressionTreeCompleteDelegateWrapper_0))]
