...
public class GetProgressionTreesForPlayerCompleteServerDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateGetProgressionTreesForPlayerCompleteServerDelegateWrapper_0 swigDelegate0;
	...
	internal GetProgressionTreesForPlayerCompleteServerDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.GetProgressionTreesForPlayerCompleteServerDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_GetProgressionTreesForPlayerCompleteServerDelegateWrapper(swigCPtr);
				}
	...
	public GetProgressionTreesForPlayerCompleteServerDelegateWrapper()
		: this(MothershipApiPINVOKE.new_GetProgressionTreesForPlayerCompleteServerDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.GetProgressionTreesForPlayerCompleteServerDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateGetProgressionTreesForPlayerCompleteServerDelegateWrapper_0))]
