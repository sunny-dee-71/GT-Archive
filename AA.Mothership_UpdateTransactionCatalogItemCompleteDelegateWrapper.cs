...
public class UpdateTransactionCatalogItemCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateUpdateTransactionCatalogItemCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal UpdateTransactionCatalogItemCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.UpdateTransactionCatalogItemCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_UpdateTransactionCatalogItemCompleteDelegateWrapper(swigCPtr);
				}
	...
	public UpdateTransactionCatalogItemCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_UpdateTransactionCatalogItemCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.UpdateTransactionCatalogItemCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateUpdateTransactionCatalogItemCompleteDelegateWrapper_0))]
