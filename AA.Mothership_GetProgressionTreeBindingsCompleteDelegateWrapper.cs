...
public class GetProgressionTreeBindingsCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateGetProgressionTreeBindingsCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal GetProgressionTreeBindingsCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.GetProgressionTreeBindingsCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_GetProgressionTreeBindingsCompleteDelegateWrapper(swigCPtr);
				}
	...
	public GetProgressionTreeBindingsCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_GetProgressionTreeBindingsCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.GetProgressionTreeBindingsCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateGetProgressionTreeBindingsCompleteDelegateWrapper_0))]
