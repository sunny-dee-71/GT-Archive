...
public class UnlockProgressionTreeNodeCompleteServerDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateUnlockProgressionTreeNodeCompleteServerDelegateWrapper_0 swigDelegate0;
	...
	internal UnlockProgressionTreeNodeCompleteServerDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.UnlockProgressionTreeNodeCompleteServerDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_UnlockProgressionTreeNodeCompleteServerDelegateWrapper(swigCPtr);
				}
	...
	public UnlockProgressionTreeNodeCompleteServerDelegateWrapper()
		: this(MothershipApiPINVOKE.new_UnlockProgressionTreeNodeCompleteServerDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.UnlockProgressionTreeNodeCompleteServerDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateUnlockProgressionTreeNodeCompleteServerDelegateWrapper_0))]
