...
{
	private struct FontAssetRef(int nameHashCode, int familyNameHashCode, int styleNameHashCode, TMP_FontAsset fontAsset)
	{
		...
		public readonly TMP_FontAsset fontAsset = fontAsset;
	}
