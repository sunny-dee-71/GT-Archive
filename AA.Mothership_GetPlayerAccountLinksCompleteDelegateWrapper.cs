...
public class GetPlayerAccountLinksCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateGetPlayerAccountLinksCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal GetPlayerAccountLinksCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.GetPlayerAccountLinksCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_GetPlayerAccountLinksCompleteDelegateWrapper(swigCPtr);
				}
	...
	public GetPlayerAccountLinksCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_GetPlayerAccountLinksCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.GetPlayerAccountLinksCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateGetPlayerAccountLinksCompleteDelegateWrapper_0))]
