...
public class QuestBeginLoginV2RequestCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateQuestBeginLoginV2RequestCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal QuestBeginLoginV2RequestCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.QuestBeginLoginV2RequestCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_QuestBeginLoginV2RequestCompleteDelegateWrapper(swigCPtr);
				}
	...
	public QuestBeginLoginV2RequestCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_QuestBeginLoginV2RequestCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.QuestBeginLoginV2RequestCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateQuestBeginLoginV2RequestCompleteDelegateWrapper_0))]
