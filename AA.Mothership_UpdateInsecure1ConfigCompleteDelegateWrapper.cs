...
public class UpdateInsecure1ConfigCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateUpdateInsecure1ConfigCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal UpdateInsecure1ConfigCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.UpdateInsecure1ConfigCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_UpdateInsecure1ConfigCompleteDelegateWrapper(swigCPtr);
				}
	...
	public UpdateInsecure1ConfigCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_UpdateInsecure1ConfigCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.UpdateInsecure1ConfigCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateUpdateInsecure1ConfigCompleteDelegateWrapper_0))]
