...
public class GetSharedGroupDataCompleteClientDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateGetSharedGroupDataCompleteClientDelegateWrapper_0 swigDelegate0;
	...
	internal GetSharedGroupDataCompleteClientDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.GetSharedGroupDataCompleteClientDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_GetSharedGroupDataCompleteClientDelegateWrapper(swigCPtr);
				}
	...
	public GetSharedGroupDataCompleteClientDelegateWrapper()
		: this(MothershipApiPINVOKE.new_GetSharedGroupDataCompleteClientDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.GetSharedGroupDataCompleteClientDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateGetSharedGroupDataCompleteClientDelegateWrapper_0))]
