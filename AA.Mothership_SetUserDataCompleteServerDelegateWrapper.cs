...
public class SetUserDataCompleteServerDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateSetUserDataCompleteServerDelegateWrapper_0 swigDelegate0;
	...
	internal SetUserDataCompleteServerDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.SetUserDataCompleteServerDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_SetUserDataCompleteServerDelegateWrapper(swigCPtr);
				}
	...
	public SetUserDataCompleteServerDelegateWrapper(MothershipServerApiClient serverApiClient)
		: this(MothershipApiPINVOKE.new_SetUserDataCompleteServerDelegateWrapper__SWIG_0(MothershipServerApiClient.getCPtr(serverApiClient)), cMemoryOwn: true)
	{
	...
	public SetUserDataCompleteServerDelegateWrapper(SetUserDataCompleteServerDelegateWrapper other)
		: this(MothershipApiPINVOKE.new_SetUserDataCompleteServerDelegateWrapper__SWIG_1(getCPtr(other)), cMemoryOwn: true)
	{
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.SetUserDataCompleteServerDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateSetUserDataCompleteServerDelegateWrapper_0))]
