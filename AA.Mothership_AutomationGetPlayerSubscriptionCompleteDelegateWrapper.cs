...
public class AutomationGetPlayerSubscriptionCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateAutomationGetPlayerSubscriptionCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal AutomationGetPlayerSubscriptionCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.AutomationGetPlayerSubscriptionCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_AutomationGetPlayerSubscriptionCompleteDelegateWrapper(swigCPtr);
				}
	...
	public AutomationGetPlayerSubscriptionCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_AutomationGetPlayerSubscriptionCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.AutomationGetPlayerSubscriptionCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateAutomationGetPlayerSubscriptionCompleteDelegateWrapper_0))]
