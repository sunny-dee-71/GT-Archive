...
public class RunTransactionCompleteServerDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateRunTransactionCompleteServerDelegateWrapper_0 swigDelegate0;
	...
	internal RunTransactionCompleteServerDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.RunTransactionCompleteServerDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_RunTransactionCompleteServerDelegateWrapper(swigCPtr);
				}
	...
	public RunTransactionCompleteServerDelegateWrapper()
		: this(MothershipApiPINVOKE.new_RunTransactionCompleteServerDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.RunTransactionCompleteServerDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateRunTransactionCompleteServerDelegateWrapper_0))]
