...
public class GetUserDataCompleteServerDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateGetUserDataCompleteServerDelegateWrapper_0 swigDelegate0;
	...
	internal GetUserDataCompleteServerDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.GetUserDataCompleteServerDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_GetUserDataCompleteServerDelegateWrapper(swigCPtr);
				}
	...
	public GetUserDataCompleteServerDelegateWrapper(MothershipServerApiClient serverApi)
		: this(MothershipApiPINVOKE.new_GetUserDataCompleteServerDelegateWrapper__SWIG_0(MothershipServerApiClient.getCPtr(serverApi)), cMemoryOwn: true)
	{
	...
	public GetUserDataCompleteServerDelegateWrapper(GetUserDataCompleteServerDelegateWrapper other)
		: this(MothershipApiPINVOKE.new_GetUserDataCompleteServerDelegateWrapper__SWIG_1(getCPtr(other)), cMemoryOwn: true)
	{
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.GetUserDataCompleteServerDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateGetUserDataCompleteServerDelegateWrapper_0))]
