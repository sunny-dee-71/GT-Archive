...
public class DeleteUserDataCompleteClientDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateDeleteUserDataCompleteClientDelegateWrapper_0 swigDelegate0;
	...
	internal DeleteUserDataCompleteClientDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.DeleteUserDataCompleteClientDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_DeleteUserDataCompleteClientDelegateWrapper(swigCPtr);
				}
	...
	public DeleteUserDataCompleteClientDelegateWrapper()
		: this(MothershipApiPINVOKE.new_DeleteUserDataCompleteClientDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.DeleteUserDataCompleteClientDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateDeleteUserDataCompleteClientDelegateWrapper_0))]
