...
public class UpdateDeploymentRequiredTagsCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateUpdateDeploymentRequiredTagsCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal UpdateDeploymentRequiredTagsCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.UpdateDeploymentRequiredTagsCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_UpdateDeploymentRequiredTagsCompleteDelegateWrapper(swigCPtr);
				}
	...
	public UpdateDeploymentRequiredTagsCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_UpdateDeploymentRequiredTagsCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.UpdateDeploymentRequiredTagsCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateUpdateDeploymentRequiredTagsCompleteDelegateWrapper_0))]
