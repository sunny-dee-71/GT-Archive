...
public class CreateTrackLevelCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateCreateTrackLevelCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal CreateTrackLevelCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.CreateTrackLevelCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_CreateTrackLevelCompleteDelegateWrapper(swigCPtr);
				}
	...
	public CreateTrackLevelCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_CreateTrackLevelCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.CreateTrackLevelCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateCreateTrackLevelCompleteDelegateWrapper_0))]
