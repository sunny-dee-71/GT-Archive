...
[Serializable]
public struct InputAnalogActionHandle_t(ulong value) : IEquatable<InputAnalogActionHandle_t>, IComparable<InputAnalogActionHandle_t>
{
	public ulong m_InputAnalogActionHandle = value;
