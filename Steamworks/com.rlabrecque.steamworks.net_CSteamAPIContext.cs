...
internal static class CSteamAPIContext
{
	...
	internal static bool Init()
	{
		...
		using (InteropHelp.UTF8StringHandle ver = new InteropHelp.UTF8StringHandle("SteamClient021"))
		{
		...
		m_pSteamUGC = SteamClient.GetISteamUGC(hSteamUser, hSteamPipe, "STEAMUGC_INTERFACE_VERSION020");
		...
		m_pSteamRemotePlay = SteamClient.GetISteamRemotePlay(hSteamUser, hSteamPipe, "STEAMREMOTEPLAY_INTERFACE_VERSION002");
		...
		using (InteropHelp.UTF8StringHandle pszVersion4 = new InteropHelp.UTF8StringHandle("STEAMTIMELINE_INTERFACE_V001"))
		{
