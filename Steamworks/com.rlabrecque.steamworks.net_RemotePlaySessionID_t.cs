...
[Serializable]
public struct RemotePlaySessionID_t(uint value) : IEquatable<RemotePlaySessionID_t>, IComparable<RemotePlaySessionID_t>
{
	public uint m_RemotePlaySessionID = value;
