...
public class GetEntitlementCatalogItemCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateGetEntitlementCatalogItemCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal GetEntitlementCatalogItemCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.GetEntitlementCatalogItemCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_GetEntitlementCatalogItemCompleteDelegateWrapper(swigCPtr);
				}
	...
	public GetEntitlementCatalogItemCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_GetEntitlementCatalogItemCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.GetEntitlementCatalogItemCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateGetEntitlementCatalogItemCompleteDelegateWrapper_0))]
