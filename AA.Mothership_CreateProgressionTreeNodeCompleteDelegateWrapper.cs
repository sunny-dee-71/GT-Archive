...
public class CreateProgressionTreeNodeCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateCreateProgressionTreeNodeCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal CreateProgressionTreeNodeCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.CreateProgressionTreeNodeCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_CreateProgressionTreeNodeCompleteDelegateWrapper(swigCPtr);
				}
	...
	public CreateProgressionTreeNodeCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_CreateProgressionTreeNodeCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.CreateProgressionTreeNodeCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateCreateProgressionTreeNodeCompleteDelegateWrapper_0))]
