...
public class DeleteProgressionTreeCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateDeleteProgressionTreeCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal DeleteProgressionTreeCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.DeleteProgressionTreeCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_DeleteProgressionTreeCompleteDelegateWrapper(swigCPtr);
				}
	...
	public DeleteProgressionTreeCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_DeleteProgressionTreeCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.DeleteProgressionTreeCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateDeleteProgressionTreeCompleteDelegateWrapper_0))]
