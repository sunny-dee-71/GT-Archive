...
public class DeleteUserDataCompleteAutomationDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateDeleteUserDataCompleteAutomationDelegateWrapper_0 swigDelegate0;
	...
	internal DeleteUserDataCompleteAutomationDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.DeleteUserDataCompleteAutomationDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_DeleteUserDataCompleteAutomationDelegateWrapper(swigCPtr);
				}
	...
	public DeleteUserDataCompleteAutomationDelegateWrapper()
		: this(MothershipApiPINVOKE.new_DeleteUserDataCompleteAutomationDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.DeleteUserDataCompleteAutomationDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateDeleteUserDataCompleteAutomationDelegateWrapper_0))]
