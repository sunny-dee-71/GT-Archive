...
public class DeleteTrackTriggerCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateDeleteTrackTriggerCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal DeleteTrackTriggerCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.DeleteTrackTriggerCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_DeleteTrackTriggerCompleteDelegateWrapper(swigCPtr);
				}
	...
	public DeleteTrackTriggerCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_DeleteTrackTriggerCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.DeleteTrackTriggerCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateDeleteTrackTriggerCompleteDelegateWrapper_0))]
