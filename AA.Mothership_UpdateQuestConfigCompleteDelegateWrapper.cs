...
public class UpdateQuestConfigCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateUpdateQuestConfigCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal UpdateQuestConfigCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.UpdateQuestConfigCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_UpdateQuestConfigCompleteDelegateWrapper(swigCPtr);
				}
	...
	public UpdateQuestConfigCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_UpdateQuestConfigCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.UpdateQuestConfigCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateUpdateQuestConfigCompleteDelegateWrapper_0))]
