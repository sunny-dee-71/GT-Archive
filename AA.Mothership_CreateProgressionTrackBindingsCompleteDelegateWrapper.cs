...
public class CreateProgressionTrackBindingsCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateCreateProgressionTrackBindingsCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal CreateProgressionTrackBindingsCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.CreateProgressionTrackBindingsCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_CreateProgressionTrackBindingsCompleteDelegateWrapper(swigCPtr);
				}
	...
	public CreateProgressionTrackBindingsCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_CreateProgressionTrackBindingsCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.CreateProgressionTrackBindingsCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateCreateProgressionTrackBindingsCompleteDelegateWrapper_0))]
