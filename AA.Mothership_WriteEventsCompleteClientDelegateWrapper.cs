...
public class WriteEventsCompleteClientDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateWriteEventsCompleteClientDelegateWrapper_0 swigDelegate0;
	...
	internal WriteEventsCompleteClientDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.WriteEventsCompleteClientDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_WriteEventsCompleteClientDelegateWrapper(swigCPtr);
				}
	...
	public WriteEventsCompleteClientDelegateWrapper()
		: this(MothershipApiPINVOKE.new_WriteEventsCompleteClientDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.WriteEventsCompleteClientDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateWriteEventsCompleteClientDelegateWrapper_0))]
