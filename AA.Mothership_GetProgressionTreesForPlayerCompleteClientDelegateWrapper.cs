...
public class GetProgressionTreesForPlayerCompleteClientDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateGetProgressionTreesForPlayerCompleteClientDelegateWrapper_0 swigDelegate0;
	...
	internal GetProgressionTreesForPlayerCompleteClientDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.GetProgressionTreesForPlayerCompleteClientDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_GetProgressionTreesForPlayerCompleteClientDelegateWrapper(swigCPtr);
				}
	...
	public GetProgressionTreesForPlayerCompleteClientDelegateWrapper()
		: this(MothershipApiPINVOKE.new_GetProgressionTreesForPlayerCompleteClientDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.GetProgressionTreesForPlayerCompleteClientDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateGetProgressionTreesForPlayerCompleteClientDelegateWrapper_0))]
