...
public class GetLastTransactionCompleteServerDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateGetLastTransactionCompleteServerDelegateWrapper_0 swigDelegate0;
	...
	internal GetLastTransactionCompleteServerDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.GetLastTransactionCompleteServerDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_GetLastTransactionCompleteServerDelegateWrapper(swigCPtr);
				}
	...
	public GetLastTransactionCompleteServerDelegateWrapper()
		: this(MothershipApiPINVOKE.new_GetLastTransactionCompleteServerDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.GetLastTransactionCompleteServerDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateGetLastTransactionCompleteServerDelegateWrapper_0))]
