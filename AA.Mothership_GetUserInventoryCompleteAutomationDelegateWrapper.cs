...
public class GetUserInventoryCompleteAutomationDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateGetUserInventoryCompleteAutomationDelegateWrapper_0 swigDelegate0;
	...
	internal GetUserInventoryCompleteAutomationDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.GetUserInventoryCompleteAutomationDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_GetUserInventoryCompleteAutomationDelegateWrapper(swigCPtr);
				}
	...
	public GetUserInventoryCompleteAutomationDelegateWrapper()
		: this(MothershipApiPINVOKE.new_GetUserInventoryCompleteAutomationDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.GetUserInventoryCompleteAutomationDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateGetUserInventoryCompleteAutomationDelegateWrapper_0))]
