...
public class DeleteProgressionTrackCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateDeleteProgressionTrackCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal DeleteProgressionTrackCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.DeleteProgressionTrackCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_DeleteProgressionTrackCompleteDelegateWrapper(swigCPtr);
				}
	...
	public DeleteProgressionTrackCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_DeleteProgressionTrackCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.DeleteProgressionTrackCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateDeleteProgressionTrackCompleteDelegateWrapper_0))]
