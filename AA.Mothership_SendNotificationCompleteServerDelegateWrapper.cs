...
public class SendNotificationCompleteServerDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateSendNotificationCompleteServerDelegateWrapper_0 swigDelegate0;
	...
	internal SendNotificationCompleteServerDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.SendNotificationCompleteServerDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_SendNotificationCompleteServerDelegateWrapper(swigCPtr);
				}
	...
	public SendNotificationCompleteServerDelegateWrapper()
		: this(MothershipApiPINVOKE.new_SendNotificationCompleteServerDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.SendNotificationCompleteServerDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateSendNotificationCompleteServerDelegateWrapper_0))]
