...
public class ListMothershipTitleDataCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateListMothershipTitleDataCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal ListMothershipTitleDataCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.ListMothershipTitleDataCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_ListMothershipTitleDataCompleteDelegateWrapper(swigCPtr);
				}
	...
	public ListMothershipTitleDataCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_ListMothershipTitleDataCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.ListMothershipTitleDataCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateListMothershipTitleDataCompleteDelegateWrapper_0))]
