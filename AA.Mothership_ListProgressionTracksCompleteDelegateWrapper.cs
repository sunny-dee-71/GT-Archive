...
public class ListProgressionTracksCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateListProgressionTracksCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal ListProgressionTracksCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.ListProgressionTracksCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_ListProgressionTracksCompleteDelegateWrapper(swigCPtr);
				}
	...
	public ListProgressionTracksCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_ListProgressionTracksCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.ListProgressionTracksCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateListProgressionTracksCompleteDelegateWrapper_0))]
