...
public class SetPrimaryAccountLinkCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateSetPrimaryAccountLinkCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal SetPrimaryAccountLinkCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.SetPrimaryAccountLinkCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_SetPrimaryAccountLinkCompleteDelegateWrapper(swigCPtr);
				}
	...
	public SetPrimaryAccountLinkCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_SetPrimaryAccountLinkCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.SetPrimaryAccountLinkCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateSetPrimaryAccountLinkCompleteDelegateWrapper_0))]
