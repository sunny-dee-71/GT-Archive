...
public class DeleteTrackLevelCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateDeleteTrackLevelCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal DeleteTrackLevelCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.DeleteTrackLevelCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_DeleteTrackLevelCompleteDelegateWrapper(swigCPtr);
				}
	...
	public DeleteTrackLevelCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_DeleteTrackLevelCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.DeleteTrackLevelCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateDeleteTrackLevelCompleteDelegateWrapper_0))]
