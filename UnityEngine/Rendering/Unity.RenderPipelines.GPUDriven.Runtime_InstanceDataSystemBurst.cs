...
internal static class InstanceDataSystemBurst
{
	...
	internal static class ReallocateInstances_000002A0$BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<ReallocateInstances_000002A0$PostfixBurstDelegate>(ReallocateInstances).Value;
			}
			P_0 = Pointer;
		}
		...
		public unsafe static void Invoke(bool implicitInstanceIndices, in NativeArray<int> rendererGroupIDs, in NativeArray<GPUDrivenPackedRendererData> packedRendererData, in NativeArray<int> instanceOffsets, in NativeArray<int> instanceCounts, ref InstanceAllocators instanceAllocators, ref CPUInstanceData instanceData, ref CPUPerCameraInstanceData perCameraInstanceData, ref CPUSharedInstanceData sharedInstanceData, ref NativeArray<InstanceHandle> instances, ref NativeParallelMultiHashMap<int, InstanceHandle> rendererGroupInstanceMultiHash)
		{
			...
			ReallocateInstances$BurstManaged(implicitInstanceIndices, in rendererGroupIDs, in packedRendererData, in instanceOffsets, in instanceCounts, ref instanceAllocators, ref instanceData, ref perCameraInstanceData, ref sharedInstanceData, ref instances, ref rendererGroupInstanceMultiHash);
		}
	}
	...
	internal static class FreeRendererGroupInstances_000002A1$BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<FreeRendererGroupInstances_000002A1$PostfixBurstDelegate>(FreeRendererGroupInstances).Value;
			}
			P_0 = Pointer;
		}
		...
		public unsafe static void Invoke(in NativeArray<int>.ReadOnly rendererGroupsID, ref InstanceAllocators instanceAllocators, ref CPUInstanceData instanceData, ref CPUPerCameraInstanceData perCameraInstanceData, ref CPUSharedInstanceData sharedInstanceData, ref NativeParallelMultiHashMap<int, InstanceHandle> rendererGroupInstanceMultiHash)
		{
			...
			FreeRendererGroupInstances$BurstManaged(in rendererGroupsID, ref instanceAllocators, ref instanceData, ref perCameraInstanceData, ref sharedInstanceData, ref rendererGroupInstanceMultiHash);
		}
	}
	...
	internal static class FreeInstances_000002A2$BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<FreeInstances_000002A2$PostfixBurstDelegate>(FreeInstances).Value;
			}
			P_0 = Pointer;
		}
		...
		public unsafe static void Invoke(in NativeArray<InstanceHandle>.ReadOnly instances, ref InstanceAllocators instanceAllocators, ref CPUInstanceData instanceData, ref CPUPerCameraInstanceData perCameraInstanceData, ref CPUSharedInstanceData sharedInstanceData, ref NativeParallelMultiHashMap<int, InstanceHandle> rendererGroupInstanceMultiHash)
		{
			...
			FreeInstances$BurstManaged(in instances, ref instanceAllocators, ref instanceData, ref perCameraInstanceData, ref sharedInstanceData, ref rendererGroupInstanceMultiHash);
		}
	}

	[BurstCompile(DisableSafetyChecks = true, OptimizeFor = OptimizeFor.Performance)]
	[MonoPInvokeCallback(typeof(ReallocateInstances_000002A0$PostfixBurstDelegate))]
	...
	{
		ReallocateInstances_000002A0$BurstDirectCall.Invoke(implicitInstanceIndices, in rendererGroupIDs, in packedRendererData, in instanceOffsets, in instanceCounts, ref instanceAllocators, ref instanceData, ref perCameraInstanceData, ref sharedInstanceData, ref instances, ref rendererGroupInstanceMultiHash);
	}

	[BurstCompile(DisableSafetyChecks = true, OptimizeFor = OptimizeFor.Performance)]
	[MonoPInvokeCallback(typeof(FreeRendererGroupInstances_000002A1$PostfixBurstDelegate))]
	public static void FreeRendererGroupInstances(in NativeArray<int>.ReadOnly rendererGroupsID, ref InstanceAllocators instanceAllocators, ref CPUInstanceData instanceData, ref CPUPerCameraInstanceData perCameraInstanceData, ref CPUSharedInstanceData sharedInstanceData, ref NativeParallelMultiHashMap<int, InstanceHandle> rendererGroupInstanceMultiHash)
	{
		FreeRendererGroupInstances_000002A1$BurstDirectCall.Invoke(in rendererGroupsID, ref instanceAllocators, ref instanceData, ref perCameraInstanceData, ref sharedInstanceData, ref rendererGroupInstanceMultiHash);
	}

	[BurstCompile(DisableSafetyChecks = true, OptimizeFor = OptimizeFor.Performance)]
	[MonoPInvokeCallback(typeof(FreeInstances_000002A2$PostfixBurstDelegate))]
	...
	{
		FreeInstances_000002A2$BurstDirectCall.Invoke(in instances, ref instanceAllocators, ref instanceData, ref perCameraInstanceData, ref sharedInstanceData, ref rendererGroupInstanceMultiHash);
	}
