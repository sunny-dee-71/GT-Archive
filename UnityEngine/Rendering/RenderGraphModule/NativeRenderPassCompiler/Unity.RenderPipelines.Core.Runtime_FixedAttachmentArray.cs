...
public struct FixedAttachmentArray<DataType>(int numAttachments) where DataType : unmanaged
{
	public static FixedAttachmentArray<DataType> Empty = new FixedAttachmentArray<DataType>(0);

	public const int MaxAttachments = 8;

	private DataType a0 = (a1 = (a2 = (a3 = (a4 = (a5 = (a6 = (a7 = new DataType())))))));
	...
	private int activeAttachments = numAttachments;
