...
internal class ShadowUtility
{
	...
	internal static class CalculateProjectionInfo_000002F8$BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<CalculateProjectionInfo_000002F8$PostfixBurstDelegate>(CalculateProjectionInfo).Value;
			}
			P_0 = Pointer;
		}
		...
		public unsafe static void Invoke(ref NativeArray<Vector3> inVertices, ref NativeArray<ShadowEdge> inEdges, ref NativeArray<int> inShapeStartingEdge, ref NativeArray<bool> inShapeIsClosedArray, ref NativeArray<Vector2> outProjectionInfo)
		{
			...
			CalculateProjectionInfo$BurstManaged(ref inVertices, ref inEdges, ref inShapeStartingEdge, ref inShapeIsClosedArray, ref outProjectionInfo);
		}
	}

	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal delegate void CalculateVertices_000002F9$PostfixBurstDelegate(ref NativeArray<Vector3> inVertices, ref NativeArray<ShadowEdge> inEdges, ref NativeArray<Vector2> inEdgeOtherPoints, ref NativeArray<ShadowMeshVertex> outMeshVertices);
	...
	internal static class CalculateVertices_000002F9$BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<CalculateVertices_000002F9$PostfixBurstDelegate>(CalculateVertices).Value;
			}
			P_0 = Pointer;
		}
		...
		public unsafe static void Invoke(ref NativeArray<Vector3> inVertices, ref NativeArray<ShadowEdge> inEdges, ref NativeArray<Vector2> inEdgeOtherPoints, ref NativeArray<ShadowMeshVertex> outMeshVertices)
		{
			...
			CalculateVertices$BurstManaged(ref inVertices, ref inEdges, ref inEdgeOtherPoints, ref outMeshVertices);
		}
	}
	...
	internal static class CalculateTriangles_000002FA$BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<CalculateTriangles_000002FA$PostfixBurstDelegate>(CalculateTriangles).Value;
			}
			P_0 = Pointer;
		}
		...
		public unsafe static void Invoke(ref NativeArray<Vector3> inVertices, ref NativeArray<ShadowEdge> inEdges, ref NativeArray<int> inShapeStartingEdge, ref NativeArray<bool> inShapeIsClosedArray, ref NativeArray<int> outMeshIndices)
		{
			...
			CalculateTriangles$BurstManaged(ref inVertices, ref inEdges, ref inShapeStartingEdge, ref inShapeIsClosedArray, ref outMeshIndices);
		}
	}
	...
	internal static class CalculateLocalBounds_000002FB$BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<CalculateLocalBounds_000002FB$PostfixBurstDelegate>(CalculateLocalBounds).Value;
			}
			P_0 = Pointer;
		}
		...
		public unsafe static void Invoke(ref NativeArray<Vector3> inVertices, out Bounds retBounds)
		{
			...
			CalculateLocalBounds$BurstManaged(ref inVertices, out retBounds);
		}
	}
	...
	internal static class GenerateInteriorMesh_000002FC$BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<GenerateInteriorMesh_000002FC$PostfixBurstDelegate>(GenerateInteriorMesh).Value;
			}
			P_0 = Pointer;
		}
		...
		public unsafe static void Invoke(ref NativeArray<ShadowMeshVertex> inVertices, ref NativeArray<int> inIndices, ref NativeArray<ShadowEdge> inEdges, out NativeArray<ShadowMeshVertex> outVertices, out NativeArray<int> outIndices, out int outStartIndex, out int outIndexCount)
		{
			...
			GenerateInteriorMesh$BurstManaged(ref inVertices, ref inIndices, ref inEdges, out outVertices, out outIndices, out outStartIndex, out outIndexCount);
		}
	}
	...
	internal static class CalculateEdgesFromLines_000002FE$BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<CalculateEdgesFromLines_000002FE$PostfixBurstDelegate>(CalculateEdgesFromLines).Value;
			}
			P_0 = Pointer;
		}
		...
		public unsafe static void Invoke(ref NativeArray<int> indices, out NativeArray<ShadowEdge> outEdges, out NativeArray<int> outShapeStartingEdge, out NativeArray<bool> outShapeIsClosedArray)
		{
			...
			CalculateEdgesFromLines$BurstManaged(ref indices, out outEdges, out outShapeStartingEdge, out outShapeIsClosedArray);
		}
	}

	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal delegate void GetVertexReferenceStats_000002FF$PostfixBurstDelegate(ref NativeArray<Vector3> vertices, ref NativeArray<ShadowEdge> edges, int vertexCount, out bool hasReusedVertices, out int newVertexCount, out NativeArray<RemappingInfo> remappingInfo);
	...
	internal static class GetVertexReferenceStats_000002FF$BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<GetVertexReferenceStats_000002FF$PostfixBurstDelegate>(GetVertexReferenceStats).Value;
			}
			P_0 = Pointer;
		}
		...
		public unsafe static void Invoke(ref NativeArray<Vector3> vertices, ref NativeArray<ShadowEdge> edges, int vertexCount, out bool hasReusedVertices, out int newVertexCount, out NativeArray<RemappingInfo> remappingInfo)
		{
			...
			GetVertexReferenceStats$BurstManaged(ref vertices, ref edges, vertexCount, out hasReusedVertices, out newVertexCount, out remappingInfo);
		}
	}
	...
	internal static class CalculateEdgesFromTriangles_00000301$BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<CalculateEdgesFromTriangles_00000301$PostfixBurstDelegate>(CalculateEdgesFromTriangles).Value;
			}
			P_0 = Pointer;
		}
		...
		public unsafe static void Invoke(ref NativeArray<Vector3> vertices, ref NativeArray<int> indices, bool duplicatesVertices, out NativeArray<Vector3> newVertices, out NativeArray<ShadowEdge> outEdges, out NativeArray<int> outShapeStartingEdge, out NativeArray<bool> outShapeIsClosedArray)
		{
			...
			CalculateEdgesFromTriangles$BurstManaged(ref vertices, ref indices, duplicatesVertices, out newVertices, out outEdges, out outShapeStartingEdge, out outShapeIsClosedArray);
		}
	}
	...
	internal static class ReverseWindingOrder_00000302$BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<ReverseWindingOrder_00000302$PostfixBurstDelegate>(ReverseWindingOrder).Value;
			}
			P_0 = Pointer;
		}
		...
		public unsafe static void Invoke(ref NativeArray<int> inShapeStartingEdge, ref NativeArray<ShadowEdge> inOutSortedEdges)
		{
			...
			ReverseWindingOrder$BurstManaged(ref inShapeStartingEdge, ref inOutSortedEdges);
		}
	}
	...
	internal static class ClipEdges_00000305$BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<ClipEdges_00000305$PostfixBurstDelegate>(ClipEdges).Value;
			}
			P_0 = Pointer;
		}
		...
		public unsafe static void Invoke(ref NativeArray<Vector3> inVertices, ref NativeArray<ShadowEdge> inEdges, ref NativeArray<int> inShapeStartingEdge, ref NativeArray<bool> inShapeIsClosedArray, float contractEdge, out NativeArray<Vector3> outVertices, out NativeArray<ShadowEdge> outEdges, out NativeArray<int> outShapeStartingEdge)
		{
			...
			ClipEdges$BurstManaged(ref inVertices, ref inEdges, ref inShapeStartingEdge, ref inShapeIsClosedArray, contractEdge, out outVertices, out outEdges, out outShapeStartingEdge);
		}
	}
	...
	[BurstCompile]
	[MonoPInvokeCallback(typeof(CalculateProjectionInfo_000002F8$PostfixBurstDelegate))]
	...
	{
		CalculateProjectionInfo_000002F8$BurstDirectCall.Invoke(ref inVertices, ref inEdges, ref inShapeStartingEdge, ref inShapeIsClosedArray, ref outProjectionInfo);
	}

	[BurstCompile]
	[MonoPInvokeCallback(typeof(CalculateVertices_000002F9$PostfixBurstDelegate))]
	...
	{
		CalculateVertices_000002F9$BurstDirectCall.Invoke(ref inVertices, ref inEdges, ref inEdgeOtherPoints, ref outMeshVertices);
	}

	[BurstCompile]
	[MonoPInvokeCallback(typeof(CalculateTriangles_000002FA$PostfixBurstDelegate))]
	...
	{
		CalculateTriangles_000002FA$BurstDirectCall.Invoke(ref inVertices, ref inEdges, ref inShapeStartingEdge, ref inShapeIsClosedArray, ref outMeshIndices);
	}

	[BurstCompile]
	[MonoPInvokeCallback(typeof(CalculateLocalBounds_000002FB$PostfixBurstDelegate))]
	internal static void CalculateLocalBounds(ref NativeArray<Vector3> inVertices, out Bounds retBounds)
	{
		CalculateLocalBounds_000002FB$BurstDirectCall.Invoke(ref inVertices, out retBounds);
	}

	[BurstCompile]
	[MonoPInvokeCallback(typeof(GenerateInteriorMesh_000002FC$PostfixBurstDelegate))]
	...
	{
		GenerateInteriorMesh_000002FC$BurstDirectCall.Invoke(ref inVertices, ref inIndices, ref inEdges, out outVertices, out outIndices, out outStartIndex, out outIndexCount);
	}
	...
	[BurstCompile]
	[MonoPInvokeCallback(typeof(CalculateEdgesFromLines_000002FE$PostfixBurstDelegate))]
	...
	{
		CalculateEdgesFromLines_000002FE$BurstDirectCall.Invoke(ref indices, out outEdges, out outShapeStartingEdge, out outShapeIsClosedArray);
	}

	[BurstCompile]
	[MonoPInvokeCallback(typeof(GetVertexReferenceStats_000002FF$PostfixBurstDelegate))]
	...
	{
		GetVertexReferenceStats_000002FF$BurstDirectCall.Invoke(ref vertices, ref edges, vertexCount, out hasReusedVertices, out newVertexCount, out remappingInfo);
	}
	...
	[BurstCompile]
	[MonoPInvokeCallback(typeof(CalculateEdgesFromTriangles_00000301$PostfixBurstDelegate))]
	...
	{
		CalculateEdgesFromTriangles_00000301$BurstDirectCall.Invoke(ref vertices, ref indices, duplicatesVertices, out newVertices, out outEdges, out outShapeStartingEdge, out outShapeIsClosedArray);
	}

	[BurstCompile]
	[MonoPInvokeCallback(typeof(ReverseWindingOrder_00000302$PostfixBurstDelegate))]
	...
	{
		ReverseWindingOrder_00000302$BurstDirectCall.Invoke(ref inShapeStartingEdge, ref inOutSortedEdges);
	}
	...
	[BurstCompile]
	[MonoPInvokeCallback(typeof(ClipEdges_00000305$PostfixBurstDelegate))]
	public static void ClipEdges(ref NativeArray<Vector3> inVertices, ref NativeArray<ShadowEdge> inEdges, ref NativeArray<int> inShapeStartingEdge, ref NativeArray<bool> inShapeIsClosedArray, float contractEdge, out NativeArray<Vector3> outVertices, out NativeArray<ShadowEdge> outEdges, out NativeArray<int> outShapeStartingEdge)
	{
		ClipEdges_00000305$BurstDirectCall.Invoke(ref inVertices, ref inEdges, ref inShapeStartingEdge, ref inShapeIsClosedArray, contractEdge, out outVertices, out outEdges, out outShapeStartingEdge);
	}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	[BurstCompile]
	internal unsafe static void CalculateVertices$BurstManaged(ref NativeArray<Vector3> inVertices, ref NativeArray<ShadowEdge> inEdges, ref NativeArray<Vector2> inEdgeOtherPoints, ref NativeArray<ShadowMeshVertex> outMeshVertices)
	{
		Vector3* buffer = (Vector3*)inVertices.m_Buffer;
		ShadowEdge* buffer2 = (ShadowEdge*)inEdges.m_Buffer;
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	[BurstCompile]
	internal static void GenerateInteriorMesh$BurstManaged(ref NativeArray<ShadowMeshVertex> inVertices, ref NativeArray<int> inIndices, ref NativeArray<ShadowEdge> inEdges, out NativeArray<ShadowMeshVertex> outVertices, out NativeArray<int> outIndices, out int outStartIndex, out int outIndexCount)
	{
		int length = inEdges.Length;
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	[BurstCompile]
	internal unsafe static void GetVertexReferenceStats$BurstManaged(ref NativeArray<Vector3> vertices, ref NativeArray<ShadowEdge> edges, int vertexCount, out bool hasReusedVertices, out int newVertexCount, out NativeArray<RemappingInfo> remappingInfo)
	{
