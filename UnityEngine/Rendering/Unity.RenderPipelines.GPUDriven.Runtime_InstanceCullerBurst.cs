...
internal static class InstanceCullerBurst
{
	...
	internal static class SetupCullingJobInput_0000014D$BurstDirectCall
	{
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<SetupCullingJobInput_0000014D$PostfixBurstDelegate>(SetupCullingJobInput).Value;
			}
			P_0 = Pointer;
		}
		...
		public unsafe static void Invoke(float lodBias, float meshLodThreshold, BatchCullingContext* context, ReceiverPlanes* receiverPlanes, ReceiverSphereCuller* receiverSphereCuller, FrustumPlaneCuller* frustumPlaneCuller, float* screenRelativeMetric, float* meshLodConstant)
		{
			...
			SetupCullingJobInput$BurstManaged(lodBias, meshLodThreshold, context, receiverPlanes, receiverSphereCuller, frustumPlaneCuller, screenRelativeMetric, meshLodConstant);
		}
	}

	[BurstCompile(DisableSafetyChecks = true, OptimizeFor = OptimizeFor.Performance)]
	[MonoPInvokeCallback(typeof(SetupCullingJobInput_0000014D$PostfixBurstDelegate))]
	...
	{
		SetupCullingJobInput_0000014D$BurstDirectCall.Invoke(lodBias, meshLodThreshold, context, receiverPlanes, receiverSphereCuller, frustumPlaneCuller, screenRelativeMetric, meshLodConstant);
	}
