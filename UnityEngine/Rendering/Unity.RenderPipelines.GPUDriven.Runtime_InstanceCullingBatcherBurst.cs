...
internal static class InstanceCullingBatcherBurst
{
	...
	internal static class RemoveDrawInstanceIndices_00000188$BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<RemoveDrawInstanceIndices_00000188$PostfixBurstDelegate>(RemoveDrawInstanceIndices).Value;
			}
			P_0 = Pointer;
		}
		...
		public unsafe static void Invoke(in NativeArray<int> drawInstanceIndices, ref NativeList<DrawInstance> drawInstances, ref NativeParallelHashMap<RangeKey, int> rangeHash, ref NativeParallelHashMap<DrawKey, int> batchHash, ref NativeList<DrawRange> drawRanges, ref NativeList<DrawBatch> drawBatches)
		{
			...
			RemoveDrawInstanceIndices$BurstManaged(in drawInstanceIndices, ref drawInstances, ref rangeHash, ref batchHash, ref drawRanges, ref drawBatches);
		}
	}
	...
	internal static class CreateDrawBatches_0000018C$BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<CreateDrawBatches_0000018C$PostfixBurstDelegate>(CreateDrawBatches).Value;
			}
			P_0 = Pointer;
		}
		...
		public unsafe static void Invoke(bool implicitInstanceIndices, in NativeArray<InstanceHandle> instances, in GPUDrivenRendererGroupData rendererData, in NativeParallelHashMap<int, BatchMeshID> batchMeshHash, in NativeParallelHashMap<int, BatchMaterialID> batchMaterialHash, in NativeParallelHashMap<int, GPUDrivenPackedMaterialData> packedMaterialDataHash, ref NativeParallelHashMap<RangeKey, int> rangeHash, ref NativeList<DrawRange> drawRanges, ref NativeParallelHashMap<DrawKey, int> batchHash, ref NativeList<DrawBatch> drawBatches, ref NativeList<DrawInstance> drawInstances)
		{
			...
			CreateDrawBatches$BurstManaged(implicitInstanceIndices, in instances, in rendererData, in batchMeshHash, in batchMaterialHash, in packedMaterialDataHash, ref rangeHash, ref drawRanges, ref batchHash, ref drawBatches, ref drawInstances);
		}
	}
	...
	[MonoPInvokeCallback(typeof(RemoveDrawInstanceIndices_00000188$PostfixBurstDelegate))]
	...
	{
		RemoveDrawInstanceIndices_00000188$BurstDirectCall.Invoke(in drawInstanceIndices, ref drawInstances, ref rangeHash, ref batchHash, ref drawRanges, ref drawBatches);
	}
	...
	[BurstCompile(DisableSafetyChecks = true, OptimizeFor = OptimizeFor.Performance)]
	[MonoPInvokeCallback(typeof(CreateDrawBatches_0000018C$PostfixBurstDelegate))]
	...
	{
		CreateDrawBatches_0000018C$BurstDirectCall.Invoke(implicitInstanceIndices, in instances, in rendererData, in batchMeshHash, in batchMaterialHash, in packedMaterialDataHash, ref rangeHash, ref drawRanges, ref batchHash, ref drawBatches, ref drawInstances);
	}
