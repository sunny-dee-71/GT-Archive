...
public static class HDROutputUtils
{
	...
	public struct HDRDisplayInformation(int maxFullFrameToneMapLuminance, int maxToneMapLuminance, int minToneMapLuminance, float hdrPaperWhiteNits)
	{
		public int maxFullFrameToneMapLuminance = maxFullFrameToneMapLuminance;

		public int maxToneMapLuminance = maxToneMapLuminance;

		public int minToneMapLuminance = minToneMapLuminance;

		public float paperWhiteNits = hdrPaperWhiteNits;
	}
