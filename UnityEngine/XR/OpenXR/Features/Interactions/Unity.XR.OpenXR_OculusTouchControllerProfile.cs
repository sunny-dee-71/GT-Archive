...
public class OculusTouchControllerProfile : OpenXRInteractionFeature
{
	...
	{
		UnityEngine.InputSystem.InputSystem.RegisterLayout(typeof(OculusTouchController), null, default(InputDeviceMatcher).WithInterface("^(XRInput)").WithProduct("Oculus Touch Controller OpenXR"));
	}

	protected override void UnregisterDeviceLayout()
	{
		UnityEngine.InputSystem.InputSystem.RemoveLayout("OculusTouchController");
	}
