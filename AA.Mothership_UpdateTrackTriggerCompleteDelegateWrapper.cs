...
public class UpdateTrackTriggerCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateUpdateTrackTriggerCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal UpdateTrackTriggerCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.UpdateTrackTriggerCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_UpdateTrackTriggerCompleteDelegateWrapper(swigCPtr);
				}
	...
	public UpdateTrackTriggerCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_UpdateTrackTriggerCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.UpdateTrackTriggerCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateUpdateTrackTriggerCompleteDelegateWrapper_0))]
