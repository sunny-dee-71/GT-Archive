...
public class CreateAccountAssociationDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateCreateAccountAssociationDelegateWrapper_0 swigDelegate0;
	...
	internal CreateAccountAssociationDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.CreateAccountAssociationDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_CreateAccountAssociationDelegateWrapper(swigCPtr);
				}
	...
	public CreateAccountAssociationDelegateWrapper()
		: this(MothershipApiPINVOKE.new_CreateAccountAssociationDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.CreateAccountAssociationDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateCreateAccountAssociationDelegateWrapper_0))]
