...
public class ListProgressionTrackBindingsCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateListProgressionTrackBindingsCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal ListProgressionTrackBindingsCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.ListProgressionTrackBindingsCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_ListProgressionTrackBindingsCompleteDelegateWrapper(swigCPtr);
				}
	...
	public ListProgressionTrackBindingsCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_ListProgressionTrackBindingsCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.ListProgressionTrackBindingsCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateListProgressionTrackBindingsCompleteDelegateWrapper_0))]
