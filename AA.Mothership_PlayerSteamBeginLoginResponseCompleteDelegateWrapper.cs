...
public class PlayerSteamBeginLoginResponseCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegatePlayerSteamBeginLoginResponseCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal PlayerSteamBeginLoginResponseCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.PlayerSteamBeginLoginResponseCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_PlayerSteamBeginLoginResponseCompleteDelegateWrapper(swigCPtr);
				}
	...
	public PlayerSteamBeginLoginResponseCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_PlayerSteamBeginLoginResponseCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.PlayerSteamBeginLoginResponseCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegatePlayerSteamBeginLoginResponseCompleteDelegateWrapper_0))]
