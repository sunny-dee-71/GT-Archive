...
public class BulkGetAccountLinksCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateBulkGetAccountLinksCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal BulkGetAccountLinksCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.BulkGetAccountLinksCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_BulkGetAccountLinksCompleteDelegateWrapper(swigCPtr);
				}
	...
	public BulkGetAccountLinksCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_BulkGetAccountLinksCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.BulkGetAccountLinksCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateBulkGetAccountLinksCompleteDelegateWrapper_0))]
