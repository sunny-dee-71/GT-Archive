...
public class ChangeCommitStatusOfOfferBindingsCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateChangeCommitStatusOfOfferBindingsCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal ChangeCommitStatusOfOfferBindingsCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.ChangeCommitStatusOfOfferBindingsCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_ChangeCommitStatusOfOfferBindingsCompleteDelegateWrapper(swigCPtr);
				}
	...
	public ChangeCommitStatusOfOfferBindingsCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_ChangeCommitStatusOfOfferBindingsCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.ChangeCommitStatusOfOfferBindingsCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateChangeCommitStatusOfOfferBindingsCompleteDelegateWrapper_0))]
