...
public class CreateDeploymentCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateCreateDeploymentCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal CreateDeploymentCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.CreateDeploymentCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_CreateDeploymentCompleteDelegateWrapper(swigCPtr);
				}
	...
	public CreateDeploymentCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_CreateDeploymentCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.CreateDeploymentCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateCreateDeploymentCompleteDelegateWrapper_0))]
