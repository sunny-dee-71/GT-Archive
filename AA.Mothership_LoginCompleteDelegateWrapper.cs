...
public class LoginCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateLoginCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal LoginCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.LoginCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_LoginCompleteDelegateWrapper(swigCPtr);
				}
	...
	public LoginCompleteDelegateWrapper(MothershipClientApiClient clientApiClient)
		: this(MothershipApiPINVOKE.new_LoginCompleteDelegateWrapper__SWIG_0(MothershipClientApiClient.getCPtr(clientApiClient)), cMemoryOwn: true)
	{
	...
	public LoginCompleteDelegateWrapper(LoginCompleteDelegateWrapper other)
		: this(MothershipApiPINVOKE.new_LoginCompleteDelegateWrapper__SWIG_1(getCPtr(other)), cMemoryOwn: true)
	{
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.LoginCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateLoginCompleteDelegateWrapper_0))]
