...
public class SetMothershipTitleDataCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateSetMothershipTitleDataCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal SetMothershipTitleDataCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.SetMothershipTitleDataCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_SetMothershipTitleDataCompleteDelegateWrapper(swigCPtr);
				}
	...
	public SetMothershipTitleDataCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_SetMothershipTitleDataCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.SetMothershipTitleDataCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateSetMothershipTitleDataCompleteDelegateWrapper_0))]
