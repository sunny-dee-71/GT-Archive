...
public class ClientGetPermissionsCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateClientGetPermissionsCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal ClientGetPermissionsCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.ClientGetPermissionsCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_ClientGetPermissionsCompleteDelegateWrapper(swigCPtr);
				}
	...
	public ClientGetPermissionsCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_ClientGetPermissionsCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.ClientGetPermissionsCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateClientGetPermissionsCompleteDelegateWrapper_0))]
