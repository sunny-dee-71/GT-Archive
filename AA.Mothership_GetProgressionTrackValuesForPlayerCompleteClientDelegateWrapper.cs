...
public class GetProgressionTrackValuesForPlayerCompleteClientDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateGetProgressionTrackValuesForPlayerCompleteClientDelegateWrapper_0 swigDelegate0;
	...
	internal GetProgressionTrackValuesForPlayerCompleteClientDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.GetProgressionTrackValuesForPlayerCompleteClientDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_GetProgressionTrackValuesForPlayerCompleteClientDelegateWrapper(swigCPtr);
				}
	...
	public GetProgressionTrackValuesForPlayerCompleteClientDelegateWrapper()
		: this(MothershipApiPINVOKE.new_GetProgressionTrackValuesForPlayerCompleteClientDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.GetProgressionTrackValuesForPlayerCompleteClientDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateGetProgressionTrackValuesForPlayerCompleteClientDelegateWrapper_0))]
