...
public class RemoveSharedGroupMembersCompleteServerDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateRemoveSharedGroupMembersCompleteServerDelegateWrapper_0 swigDelegate0;
	...
	internal RemoveSharedGroupMembersCompleteServerDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.RemoveSharedGroupMembersCompleteServerDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_RemoveSharedGroupMembersCompleteServerDelegateWrapper(swigCPtr);
				}
	...
	public RemoveSharedGroupMembersCompleteServerDelegateWrapper()
		: this(MothershipApiPINVOKE.new_RemoveSharedGroupMembersCompleteServerDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.RemoveSharedGroupMembersCompleteServerDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateRemoveSharedGroupMembersCompleteServerDelegateWrapper_0))]
