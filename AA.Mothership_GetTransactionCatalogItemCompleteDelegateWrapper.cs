...
public class GetTransactionCatalogItemCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateGetTransactionCatalogItemCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal GetTransactionCatalogItemCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.GetTransactionCatalogItemCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_GetTransactionCatalogItemCompleteDelegateWrapper(swigCPtr);
				}
	...
	public GetTransactionCatalogItemCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_GetTransactionCatalogItemCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.GetTransactionCatalogItemCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateGetTransactionCatalogItemCompleteDelegateWrapper_0))]
