...
public class GetUserDataCompleteClientDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateGetUserDataCompleteClientDelegateWrapper_0 swigDelegate0;
	...
	internal GetUserDataCompleteClientDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.GetUserDataCompleteClientDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_GetUserDataCompleteClientDelegateWrapper(swigCPtr);
				}
	...
	public GetUserDataCompleteClientDelegateWrapper(MothershipClientApiClient clientApi)
		: this(MothershipApiPINVOKE.new_GetUserDataCompleteClientDelegateWrapper__SWIG_0(MothershipClientApiClient.getCPtr(clientApi)), cMemoryOwn: true)
	{
	...
	public GetUserDataCompleteClientDelegateWrapper(GetUserDataCompleteClientDelegateWrapper other)
		: this(MothershipApiPINVOKE.new_GetUserDataCompleteClientDelegateWrapper__SWIG_1(getCPtr(other)), cMemoryOwn: true)
	{
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.GetUserDataCompleteClientDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateGetUserDataCompleteClientDelegateWrapper_0))]
