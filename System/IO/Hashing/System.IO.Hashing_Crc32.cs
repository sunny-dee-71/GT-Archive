...
public sealed class Crc32 : NonCryptographicHashAlgorithm
{
	...
	private static ReadOnlySpan<uint> CrcLookup
	{
		get
		{
			object obj = global::<PrivateImplementationDetails>.12F3E0576D447EB37B36D82BA0C1C5481B8F0D12FDC70347CE4A076B229D4C86_A14;
			if (obj == null)
			{
				obj = new uint[256]
				{
				...
				global::<PrivateImplementationDetails>.12F3E0576D447EB37B36D82BA0C1C5481B8F0D12FDC70347CE4A076B229D4C86_A14 = (uint[])obj;
			}
