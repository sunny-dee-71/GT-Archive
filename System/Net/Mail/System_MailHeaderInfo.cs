...
{
	private readonly struct HeaderInfo(MailHeaderID id, string name, bool isSingleton, bool isUserSettable, bool allowsUnicode)
	{
		public readonly string NormalizedName = name;

		public readonly bool IsSingleton = isSingleton;

		public readonly MailHeaderID ID = id;

		public readonly bool IsUserSettable = isUserSettable;

		public readonly bool AllowsUnicode = allowsUnicode;
	}
