...
{
	public struct DelayedQName(ref Record rec)
	{
		private string prefix = rec.prefix;

		private string localName = rec.localName;
	...
	public struct XsltAttribute(string name, int flags)
	{
