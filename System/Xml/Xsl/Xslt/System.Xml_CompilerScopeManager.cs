...
internal sealed class CompilerScopeManager<V>
{
	...
	internal struct NamespaceEnumerator(CompilerScopeManager<V> scope)
	{
		private CompilerScopeManager<V> scope = scope;

		private int lastRecord = scope.lastRecord;

		private int currentRecord = lastRecord + 1;
