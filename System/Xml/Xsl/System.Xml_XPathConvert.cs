...
internal static class XPathConvert
{
	private struct BigNumber
	{
		...
		private static readonly BigNumber[] TenPowersPos;

		private static readonly BigNumber[] TenPowersNeg;
