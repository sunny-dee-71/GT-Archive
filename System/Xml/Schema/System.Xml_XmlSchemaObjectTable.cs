...
public class XmlSchemaObjectTable
{
	...
	internal struct XmlSchemaObjectEntry(XmlQualifiedName name, XmlSchemaObject value)
	{
		internal XmlQualifiedName qname = name;

		internal XmlSchemaObject xso = value;
