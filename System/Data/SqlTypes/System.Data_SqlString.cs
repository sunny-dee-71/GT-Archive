...
public struct SqlString : INullable, IComparable, IXmlSerializable
{
	...
	{
		this = new SqlString(lcid, compareOptions, data, 0, data.Length, fUnicode: true);
	}
	...
	{
		this = new SqlString(data, lcid, s_iDefaultFlag);
	}
	...
	{
		this = new SqlString(data, CultureInfo.CurrentCulture.LCID, s_iDefaultFlag);
	}
	...
	static SqlString()
	{
		Null = new SqlString(fNull: true);
		s_unicodeEncoding = new UnicodeEncoding();
		IgnoreCase = 1;
		IgnoreWidth = 16;
		IgnoreNonSpace = 2;
		IgnoreKanaType = 8;
		BinarySort = 32768;
		BinarySort2 = 16384;
		s_iDefaultFlag = SqlCompareOptions.IgnoreCase | SqlCompareOptions.IgnoreKanaType | SqlCompareOptions.IgnoreWidth;
		s_iValidCompareOptionMask = CompareOptions.IgnoreCase | CompareOptions.IgnoreNonSpace | CompareOptions.IgnoreKanaType | CompareOptions.IgnoreWidth;
		s_iValidSqlCompareOptionMask = SqlCompareOptions.IgnoreCase | SqlCompareOptions.IgnoreNonSpace | SqlCompareOptions.IgnoreKanaType | SqlCompareOptions.IgnoreWidth | SqlCompareOptions.BinarySort | SqlCompareOptions.BinarySort2;
		s_lcidUSEnglish = 1033;
		s_lcidBinary = 33280;
	}
}
