...
public struct SqlDecimal : INullable, IComparable, IXmlSerializable
{
	...
	{
		this = new SqlDecimal(fNull: false);
		_bStatus = s_bNotNull;
		if (dVal < 0.0)
		{
			dVal = 0.0 - dVal;
	...
	static SqlDecimal()
	{
		s_NUMERIC_MAX_PRECISION = 38;
		MaxPrecision = s_NUMERIC_MAX_PRECISION;
		MaxScale = s_NUMERIC_MAX_PRECISION;
		s_bNullMask = 1;
		s_bIsNull = 0;
		s_bNotNull = 1;
		s_bReverseNullMask = (byte)(~s_bNullMask);
		s_bSignMask = 2;
		s_bPositive = 0;
		s_bNegative = 2;
		s_bReverseSignMask = (byte)(~s_bSignMask);
		s_uiZero = 0u;
		s_cNumeMax = 4;
		s_lInt32Base = 4294967296L;
		s_ulInt32Base = 4294967296uL;
		s_ulInt32BaseForMod = s_ulInt32Base - 1;
		s_llMax = 9223372036854775807uL;
		s_ulBase10 = 10u;
		s_DUINT_BASE = s_lInt32Base;
		s_DUINT_BASE2 = s_DUINT_BASE * s_DUINT_BASE;
		s_DUINT_BASE3 = s_DUINT_BASE2 * s_DUINT_BASE;
		s_DMAX_NUME = 1E+38;
		s_DBL_DIG = 17u;
		s_cNumeDivScaleMin = 6;
		s_rgulShiftBase = new uint[9] { 10u, 100u, 1000u, 10000u, 100000u, 1000000u, 10000000u, 100000000u, 1000000000u };
		s_decimalHelpersLo = new uint[38]
		{
		...
		s_decimalHelpersMid = new uint[38]
		{
		...
		s_decimalHelpersHi = new uint[38]
		{
		...
		s_decimalHelpersHiHi = new uint[38]
		{
			0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u,
			0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u,
		...
		s_ulT8 = 100000000u;
		s_ulT9 = 1000000000u;
		s_dwlT10 = 10000000000uL;
		s_dwlT11 = 100000000000uL;
		s_dwlT12 = 1000000000000uL;
		s_dwlT13 = 10000000000000uL;
		s_dwlT14 = 100000000000000uL;
		s_dwlT15 = 1000000000000000uL;
		s_dwlT16 = 10000000000000000uL;
		s_dwlT17 = 100000000000000000uL;
		s_dwlT18 = 1000000000000000000uL;
		s_dwlT19 = 10000000000000000000uL;
		Null = new SqlDecimal(fNull: true);
