...
public struct SqlMoney : INullable, IComparable, IXmlSerializable
{
	...
	static SqlMoney()
	{
		s_iMoneyScale = 4;
		s_lTickBase = 10000L;
		s_dTickBase = s_lTickBase;
		s_minLong = long.MinValue / s_lTickBase;
		s_maxLong = long.MaxValue / s_lTickBase;
		Null = new SqlMoney(fNull: true);
		Zero = new SqlMoney(0);
		MinValue = new SqlMoney(long.MinValue, 0);
		MaxValue = new SqlMoney(long.MaxValue, 0);
	}
}
