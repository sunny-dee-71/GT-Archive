...
public struct SqlDateTime : INullable, IComparable, IXmlSerializable
{
	...
	static SqlDateTime()
	{
		s_SQLTicksPerMillisecond = 0.3;
		SQLTicksPerSecond = 300;
		SQLTicksPerMinute = SQLTicksPerSecond * 60;
		SQLTicksPerHour = SQLTicksPerMinute * 60;
		s_SQLTicksPerDay = SQLTicksPerHour * 24;
		s_ticksPerSecond = 10000000L;
		s_SQLBaseDate = new DateTime(1900, 1, 1);
		s_SQLBaseDateTicks = s_SQLBaseDate.Ticks;
		s_minYear = 1753;
		s_maxYear = 9999;
		s_minDay = -53690;
		s_maxDay = 2958463;
		s_minTime = 0;
		s_maxTime = s_SQLTicksPerDay - 1;
		s_dayBase = 693595;
		s_daysToMonth365 = new int[13]
		{
			0, 31, 59, 90, 120, 151, 181, 212, 243, 273,
			304, 334, 365
		};
		s_daysToMonth366 = new int[13]
		{
			0, 31, 60, 91, 121, 152, 182, 213, 244, 274,
			305, 335, 366
		};
		s_minDateTime = new DateTime(1753, 1, 1);
		s_maxDateTime = DateTime.MaxValue;
		s_minTimeSpan = s_minDateTime.Subtract(s_SQLBaseDate);
		s_maxTimeSpan = s_maxDateTime.Subtract(s_SQLBaseDate);
		s_ISO8601_DateTimeFormat = "yyyy-MM-ddTHH:mm:ss.fff";
		s_dateTimeFormats = new string[8] { "MMM d yyyy hh:mm:ss:ffftt", "MMM d yyyy hh:mm:ss:fff", "d MMM yyyy hh:mm:ss:ffftt", "d MMM yyyy hh:mm:ss:fff", "hh:mm:ss:ffftt", "hh:mm:ss:fff", "yyMMdd", "yyyyMMdd" };
		MinValue = new SqlDateTime(s_minDay, 0);
		MaxValue = new SqlDateTime(s_maxDay, s_maxTime);
		Null = new SqlDateTime(fNull: true);
	}
}
