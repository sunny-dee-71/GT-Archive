...
public class SubscriptionsByPlayerMap : IDisposable, IDictionary<string, SubscriptionsVector>, ICollection<KeyValuePair<string, SubscriptionsVector>>, IEnumerable<KeyValuePair<string, SubscriptionsVector>>, IEnumerable
{
	public sealed class SubscriptionsByPlayerMapEnumerator : IEnumerator, IEnumerator<KeyValuePair<string, SubscriptionsVector>>, IDisposable
	{
		...
		public KeyValuePair<string, SubscriptionsVector> Current
		{
			get
			{
				...
				return (KeyValuePair<string, SubscriptionsVector>)currentObject;
			}
		}
		...
		public bool MoveNext()
		{
			...
			if (currentIndex + 1 < count)
			{
				...
				if (num != 0)
				{
					...
					currentObject = new KeyValuePair<string, SubscriptionsVector>(key, collectionRef[key]);
					return (byte)num != 0;
				}
			}
			else
	...
	public ICollection<SubscriptionsVector> Values
	{
		get
		{
			...
			using SubscriptionsByPlayerMapEnumerator subscriptionsByPlayerMapEnumerator = GetEnumerator();
			while (subscriptionsByPlayerMapEnumerator.MoveNext())
			{
				collection.Add(subscriptionsByPlayerMapEnumerator.Current.Value);
			}
			return collection;
		}
	}
	...
	protected virtual void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_SubscriptionsByPlayerMap(swigCPtr);
				}
	...
	{
		return new SubscriptionsByPlayerMapEnumerator(this);
	}
	...
	public SubscriptionsByPlayerMapEnumerator GetEnumerator()
	{
		return new SubscriptionsByPlayerMapEnumerator(this);
	}

	public SubscriptionsByPlayerMap()
		: this(MothershipApiPINVOKE.new_SubscriptionsByPlayerMap__SWIG_0(), cMemoryOwn: true)
	{
	...
	public SubscriptionsByPlayerMap(SubscriptionsByPlayerMap other)
		: this(MothershipApiPINVOKE.new_SubscriptionsByPlayerMap__SWIG_1(getCPtr(other)), cMemoryOwn: true)
	{
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
	...
	private uint size()
	{
		uint result = MothershipApiPINVOKE.SubscriptionsByPlayerMap_size(swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public bool empty()
	{
		bool result = MothershipApiPINVOKE.SubscriptionsByPlayerMap_empty(swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	public void Clear()
	{
		MothershipApiPINVOKE.SubscriptionsByPlayerMap_Clear(swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		SubscriptionsVector result = new SubscriptionsVector(MothershipApiPINVOKE.SubscriptionsByPlayerMap_getitem(swigCPtr, key), cMemoryOwn: false);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipApiPINVOKE.SubscriptionsByPlayerMap_setitem(swigCPtr, key, SubscriptionsVector.getCPtr(x));
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = MothershipApiPINVOKE.SubscriptionsByPlayerMap_ContainsKey(swigCPtr, key);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipApiPINVOKE.SubscriptionsByPlayerMap_Add(swigCPtr, key, SubscriptionsVector.getCPtr(val));
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		bool result = MothershipApiPINVOKE.SubscriptionsByPlayerMap_Remove(swigCPtr, key);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		IntPtr result = MothershipApiPINVOKE.SubscriptionsByPlayerMap_create_iterator_begin(swigCPtr);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		string result = MothershipApiPINVOKE.SubscriptionsByPlayerMap_get_next_key(swigCPtr, swigiterator);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
	...
	{
		MothershipApiPINVOKE.SubscriptionsByPlayerMap_destroy_iterator(swigCPtr, swigiterator);
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
		}
