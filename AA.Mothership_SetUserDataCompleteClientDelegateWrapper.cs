...
public class SetUserDataCompleteClientDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateSetUserDataCompleteClientDelegateWrapper_0 swigDelegate0;
	...
	internal SetUserDataCompleteClientDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.SetUserDataCompleteClientDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_SetUserDataCompleteClientDelegateWrapper(swigCPtr);
				}
	...
	public SetUserDataCompleteClientDelegateWrapper(MothershipClientApiClient clientApiClient)
		: this(MothershipApiPINVOKE.new_SetUserDataCompleteClientDelegateWrapper__SWIG_0(MothershipClientApiClient.getCPtr(clientApiClient)), cMemoryOwn: true)
	{
	...
	public SetUserDataCompleteClientDelegateWrapper(SetUserDataCompleteClientDelegateWrapper other)
		: this(MothershipApiPINVOKE.new_SetUserDataCompleteClientDelegateWrapper__SWIG_1(getCPtr(other)), cMemoryOwn: true)
	{
		if (MothershipApiPINVOKE.SWIGPendingException.Pending)
		{
			throw MothershipApiPINVOKE.SWIGPendingException.Retrieve();
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.SetUserDataCompleteClientDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateSetUserDataCompleteClientDelegateWrapper_0))]
