...
public class GetDeploymentCompleteDelegateWrapper : MothershipRequestCompleteDelegateWrapper
{
	...
	private SwigDelegateGetDeploymentCompleteDelegateWrapper_0 swigDelegate0;
	...
	internal GetDeploymentCompleteDelegateWrapper(IntPtr cPtr, bool cMemoryOwn)
		: base(MothershipApiPINVOKE.GetDeploymentCompleteDelegateWrapper_SWIGUpcast(cPtr), cMemoryOwn)
	{
	...
	protected override void Dispose(bool disposing)
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					MothershipApiPINVOKE.delete_GetDeploymentCompleteDelegateWrapper(swigCPtr);
				}
	...
	public GetDeploymentCompleteDelegateWrapper()
		: this(MothershipApiPINVOKE.new_GetDeploymentCompleteDelegateWrapper(), cMemoryOwn: true)
	{
	...
	private void SwigDirectorConnect()
	{
		...
		MothershipApiPINVOKE.GetDeploymentCompleteDelegateWrapper_director_connect(swigCPtr, swigDelegate0);
	}
	...
	[MonoPInvokeCallback(typeof(SwigDelegateGetDeploymentCompleteDelegateWrapper_0))]
